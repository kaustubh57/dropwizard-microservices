package com.myexperiments.mainapp.client;
...
public class MainappClient {
    ...
    public MainappClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public MainappClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
    ...
    private static Client buildClient(JerseyClientBuilder clientBuilder) {
        ...
        return builder
            ...
            .using(jerseyConfig).build("mainappClient");
    }
}
