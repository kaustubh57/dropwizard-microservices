package com.myexperiments.mainappattachment.client;
...
public class MainappattachmentClient {

    private final Client client;
    private final JerseyClientBuilder clientBuilder;
    private final URI root;

    public MainappattachmentClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public MainappattachmentClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
    ...
    private static Client buildClient(JerseyClientBuilder clientBuilder) {
        ...
        return builder
            ...
            .using(jerseyConfig).build("mainappattachmentClient");
    }
}
